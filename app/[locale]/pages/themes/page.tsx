...
const colorVariables = [
  ...
  { name: 'Destructive', var: '--destructive', className: 'bg-destructive' },
  {
    name: 'Roll Positive',
    var: '--roll-positive',
    className: 'bg-roll-positive',
  },
  {
    name: 'Roll Positive Foreground',
    var: '--roll-positive-foreground',
    className: 'bg-roll-positive-foreground',
  },
  {
    name: 'Roll Negative',
    var: '--roll-negative',
    className: 'bg-roll-negative',
  },
  {
    name: 'Roll Negative Foreground',
    var: '--roll-negative-foreground',
    className: 'bg-roll-negative-foreground',
  },
]
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
              {colorVariables.map((color) => (
                <div key={color.var} className="flex items-center gap-2">
                  <div
                    className={`w-8 h-8 rounded border ${color.className}`}
                  />
    ...
    <div className="container mx-auto py-8 px-4">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          View all available themes in both light and dark modes. Each theme
          displays the same dice roll result for comparison.
        </p>
      </div>
